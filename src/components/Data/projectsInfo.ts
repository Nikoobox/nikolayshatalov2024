export const PROJECTS_DATA = [
  {
    ...
    infoLong:
      "Avarts is a full-stack platform that helps athletes explore and understand their Strava activity data through interactive visualizations and AI-generated insights powered by the OpenAI API. It connects to Strava via OAuth and webhooks to keep activity data in sync in real time, and enriches each activity with contextual information such as weather and geolocation. \n\nUsers can browse their rides, runs, and swims on GPS maps and heatmaps, analyze long-term trends through charts, and save favorite activities for quick access. AI-powered activity analysis provides personalized insights based on performance patterns. \n\nThe app is available as a Progressive Web App and on the iOS App Store. Avarts was approved by Strava for production use, meeting their API, performance, and security requirements.",
    techDescription:
